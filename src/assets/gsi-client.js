...
(function (_) {
  ...
  */
    ...
    ac.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.mb = !1))
        : ((b = new Zb(b, this.src, f, !!d, e)), (b.mb = c), a.push(b));
      return b;
    };
    ...
    var bc = function (a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.Xa && f.listener == b && f.capture == !!c && f.wa == d) return e;
      }
      return -1;
    };
    ...
    oc = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.ib(d) ? !!d.capture : !!d),
          ...
          _.Xb(a)
            ? a.Da(b, c, d, e)
            : a && (a = _.kc(a)) && (b = a.Ta(b, c, d, e)) && _.pc(b);
    };
    _.pc = function (a) {
  ...
  try {
    ...
    _.l.remove = function (a, b, c) {
      ...
      this.set(a, "", { Tb: 0, path: b, domain: c });
      return d;
    };
    _.l.Sa = function () {
      return ed(this).keys;
  ...
  try {
    ...
    _.Wd = function (a, b, c) {
      if (null != a && "object" === typeof a && a.sb === Vd) return a;
      if (Array.isArray(a)) {
        var d = (0, _.Md)(a),
          e = d;
        0 === e && (e |= c & 32);
    ...
    He = [];
    Ie = function (a) {
      a.C && a.ac && (a.C.ontimeout = null);
      a.ub && (_.v.clearTimeout(a.ub), (a.ub = null));
    };
    Je = function (a) {
    ...
    Ke = function (a) {
      a.Lb ||
        ((a.Lb = !0), a.dispatchEvent("complete"), a.dispatchEvent("error"));
    };
    Le = function (a, b) {
      if (a.C) {
        Ie(a);
        var c = a.C,
          d = a.wb[0] ? function () {} : null;
        a.C = null;
        a.wb = null;
    ...
    _.Oe = function (a) {
      ...
      if (!c) {
        if ((b = 0 === b))
          (a = String(a.Rb).match(_.wc)[1] || null),
            !a &&
              _.v.self &&
              _.v.self.location &&
    ...
    Pe = function (a) {
      if (
        ...
        (!a.wb[1] || 4 != Ne(a) || 2 != a.ob())
      )
        if (a.qb && 4 == Ne(a)) Ee(a.Nc, 0, a);
    ...
    Re = function (a) {
      ...
      this.wb = this.C = null;
      this.Rb = "";
      this.ya = this.Ob = this.qb = this.Lb = !1;
      this.vb = 0;
      this.ub = null;
      this.Sc = "";
      this.ac = this.Td = this.bc = !1;
    ...
    _.l.send = function (a, b, c, d) {
      if (this.C) throw Error("y`" + this.Rb + "`" + a);
      b = b ? b.toUpperCase() : "GET";
      this.Rb = a;
      this.Lb = !1;
      this.ma = !0;
      this.C = new XMLHttpRequest();
      this.wb = this.Wc ? De(this.Wc) : De(_.uc);
      this.C.onreadystatechange = (0, _.lb)(this.Nc, this);
      this.Td &&
        "onprogress" in this.C &&
        ((this.C.onprogress = (0, _.lb)(function (g) {
          this.Mc(g, !0);
        }, this)),
        this.C.upload && (this.C.upload.onprogress = (0, _.lb)(this.Mc, this)));
      try {
        (this.Ob = !0), this.C.open(b, String(a), !0), (this.Ob = !1);
      } catch (g) {
        Me(this);
        return;
      }
      ...
      this.Sc && (this.C.responseType = this.Sc);
      "withCredentials" in this.C &&
        this.C.withCredentials !== this.bc &&
        (this.C.withCredentials = this.bc);
      if ("setTrustToken" in this.C && this.Zb)
        try {
          this.C.setTrustToken(this.Zb);
        } catch (g) {}
      if ("setAttributionReporting" in this.C && this.Eb)
        try {
          this.C.setAttributionReporting(this.Eb);
        } catch (g) {}
      try {
        Ie(this),
          0 < this.vb &&
            ((this.ac = Je(this.C))
              ? ((this.C.timeout = this.vb),
                (this.C.ontimeout = (0, _.lb)(this.Uc, this)))
              : (this.ub = Ee(this.Uc, this.vb, this))),
          (this.qb = !0),
          this.C.send(a),
          (this.qb = !1);
      } catch (g) {
    ...
    _.l.Nc = function () {
      this.Gc() || (this.Ob || this.qb || this.ya ? Pe(this) : this.Sd());
    };
    _.l.Sd = function () {
      Pe(this);
    };
  ...
  */
    ...
    _.X = function (a) {
      return _.Zi(a, _.Ui) ? _.ej(dj(a.zb)) : String(a).replace(aj, bj);
    };
    _.jj = function (a) {
      ...
      Gj = function (a) {
        ...
        switch (a) {
          case 1:
            ...
            break;
          case 3:
            b += "Registrarse con Google";
            break;
          case 4:
            b += "Continuar con Google";
            break;
          default:
      ...
      tj = function (a) {
        ...
        c.profilePicture
          ? ((b +=
              ...
              '" alt="'),
            (h = "Imagen de perfil de " + _.X(e ? e : c.id)),
            (b += _.ej(h)),
            (b += '">'))
          : (b += _.rj());
        h =
  ...
  try {
    ...
    _.Sm.prototype.Sb = function (a, b, c, d) {
  ...
  try {
    ...
    _.M(_.Ao, _.L);
    _.Bo = [0, _.Af, -1, _.Bf, _.Af, -2, _.Bf, _.Af];
  } catch (e) {
    _._DumpException(e);
  }
  try {
    ...
    No = !_.yb && !_.Ea();
    _.Oo = function (a) {
      if (No && a.dataset) return a.dataset;
      var b = {};
      a = a.attributes;
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (0 == d.name.lastIndexOf("data-", 0)) {
          var e = _.Lo(d.name.slice(5));
          b[e] = d.value;
        }
      }
      return b;
    ...
    _.Qo = (function () {
      ...
      if (_.bd) {
        ...
        return Po(/Chrome\/([0-9.]+)/);
      }
      if (_.cd && !_.Ia()) return Po(/Version\/([0-9.]+)/);
      if (_.Zc || _.$c) {
  ...
  try {
    ...
    Wo = function (a) {
      ...
      if ("string" === typeof a) return bp(a);
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++)
          if ("string" !== typeof a[b] || !bp(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    bp = function (a) {
      try {
        ...
        a = c;
        b = "Qb";
        if (cp.Qb && cp.hasOwnProperty(b)) var d = cp.Qb;
        else {
          var e = new cp();
          d = cp.Qb = e;
        }
    ...
    Yo = function () {
      ep ||
        (ep = _.C(window, "message", function (a) {
          a = a.g;
          if (a.data) {
            var b = a.data;
    ...
    _.ip = function (a) {
      _.To
        ? _.Uo({ command: "intermediate_iframe_resize", height: a })
        : _.y(
    ...
    _.jp = function () {
      _.To
        ? _.Uo({ command: "intermediate_iframe_close" })
        : _.y(
    ...
    _.kp = function (a) {
      _.To
        ? _.Uo({ command: "set_tap_outside_mode", cancel: a })
        : _.y(
    ...
    var np = function (a, b) {
      ...
      for (var c in a.P) np(a.P[c], b);
    };
    lp.prototype.Sa = function (a) {
      var b = [];
      if (a) {
    ...
    var op = function (a, b, c) {
      void 0 !== a.g && c.push(b);
      for (var d in a.P) op(a.P[d], b + d, c);
    };
    ...
    lp.prototype.remove = function (a) {
      ...
      for (delete b.g; 0 < c.length; )
        if (((e = c.pop()), (b = e[0]), (e = e[1]), b.P[e].rb())) delete b.P[e];
        else break;
      return a;
    };
    lp.prototype.rb = function () {
      var a;
      if ((a = void 0 === this.g))
        a: {
          for (var b in this.P) {
    ...
    var cp = function () {
      ...
      qp = function (a, b, c, d) {
        ...
        a++;
        if ("?" == e || "," == e) return a;
        do (a = qp(a, b, c, d)), (e = c.charAt(a));
        while ("?" != e && "," != e);
        return a + 1;
      };
    var Xo, ep, Vo, Zo, $o;
    _.A("google.accounts.id.intermediate.verifyParentOrigin", _.ap);
    _.A("google.accounts.id.intermediate.notifyParentResize", _.ip);
    _.A("google.accounts.id.intermediate.notifyParentClose", _.jp);
    _.A("google.accounts.id.intermediate.notifyParentDone", function () {
      _.To
        ? _.Uo({ command: "intermediate_iframe_done" })
        : _.y(
            "Done command was not sent due to missing verified parent origin."
          );
    });
    _.A("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.kp);
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var rp = function (a, b) {
      ...
      Bp = function (a, b) {
        ...
        return function (f, g, h) {
          return e(f, g, h, d || (d = yp(b).La), c || (c = Ap(b)));
        };
      },
      yp = function (a) {
        var b = a[_.ye];
        if (b) return b;
        b = _.ve(a, (a[_.ye] = {}), xp, Bp);
        _.ze(a);
        return b;
      },
      Cp = function (a, b) {
      ...
      zp = function (a, b, c) {
        ...
        if (d & 256) {
          ...
          for (var p in d)
            (e = +p),
              Number.isNaN(e) ||
                ((f = d[p]), null != f && (g = Cp(c, e)) && g(b, f, e));
        }
        if ((a = _.Pd ? a[_.Pd] : void 0))
          for (Dp(b, b.g.end()), c = 0; c < a.length; c++)
            Dp(b, _.Bd(a[c]) || _.zd());
      },
      Ep = function (a, b) {
        var c = [];
      ...
      Hp = function () {
        var a = _.So().toString(),
          b = { Tb: 300, path: "/", Yb: !0 },
          c;
        if ((c = _.Da())) c = 0 <= _.ok(_.Qo, 80);
        c && (b.Xb = "none");
        c = _.Pc(location.origin);
        "http" === c.h &&
          "localhost" === c.g &&
          ((b.Yb = void 0), (b.Xb = void 0));
        _.fd.set("g_csrf_token", a, b);
        return a;
      },
      Lp = function (a, b, c) {
        Ip = a ? a + "/gsi/log" : "https://accounts.google.com/gsi/log";
        Jp = b;
        Kp = c;
      },
      Np = function (a, b) {
        Mp >= (void 0 === b ? 100 : b) ||
          ((b = new _.Bc(Ip)),
          _.Ec(b, _.Tc({ client_id: Jp, as: Kp, event: a.toString() })),
          _.$e(
            b.toString(),
            void 0,
            "POST",
            ...
            void 0,
            void 0,
            "https://accounts.google.com/gsi/log" !== Ip
          ));
      },
      Rp = function (a) {
        var b = new (Function.prototype.bind.apply(
          Op,
          [null, "onetap", a, "prompt"].concat(Pp(Qp.apply(1, arguments)))
        ))();
        Np(b);
      },
      Sp = function () {
        var a = new (Function.prototype.bind.apply(
          Op,
          [null, "onetap", void 0, "closed"].concat(Pp(Qp.apply(0, arguments)))
        ))();
        Np(a);
      },
      Tp = function () {
        var a = new (Function.prototype.bind.apply(
          Op,
          [null, "id", void 0, "init"].concat(Pp(Qp.apply(0, arguments)))
        ))();
        Np(a);
      },
      Up = function () {
        var a = new (Function.prototype.bind.apply(
          Op,
          [null, "onetap", void 0, "policy"].concat(Pp(Qp.apply(0, arguments)))
        ))();
        Np(a);
      },
      Xp = function (a) {
        var b = void 0 === b ? "googleidentityservice" : b;
        if (!(document.getElementById(b) && Vp.get(b) && Vp.get(b))) {
          var c = new _.Ef(),
      ...
      aq = function (a, b, c, d) {
        ...
        e.id = c;
        e.title = "Bot\u00f3n Iniciar sesi\u00f3n con Google";
        ...
        if (a) {
          ...
          if ((d = a.login_uri)) {
            ...
            if ("https" !== b.h && "localhost" !== b.g)
              throw (
                (Tp("unsecuredLoginUri", d),
                new lq("Unsecured login_uri provided."))
              );
            d = b.toString();
            a.login_uri = d;
          }
          d && !a.callback && (a.callback = mq(d, c));
          "redirect" !== a.ux_mode ||
            d ||
      ...
      wq = function (a, b, c) {
        var d = sq.__G_ID_CLIENT__;
        d || (vq(), (d = sq.__G_ID_CLIENT__));
        d.sa(a, b, c);
      },
      yq = function (a, b, c) {
        if (a && b) {
      ...
      Aq = function () {
        var a = sq.__G_ID_CLIENT__;
        a || (vq(), (a = sq.__G_ID_CLIENT__));
        zq(a.D);
      },
      Bq = function () {
      ...
      Fq = function (a, b, c) {
        ...
        Eq(c, "access_type", g);
        Eq(c, "hd", n);
        Eq(c, "response_type", f);
        Eq(c, "include_granted_scopes", !1 === p ? "false" : "true");
        Eq(c, "enable_granular_consent", !1 === r ? "false" : "true");
        return b + "?" + c.join("&");
      },
      Hq = function (a, b) {
        if (!b.client_id)
    ...
    Sq.prototype.o = function (a, b) {
      null != b && null != b && (Qq(this.g, 8 * a), Rq(this.g, b));
    };
    Sq.prototype.l = function (a, b) {
      null != b && (Qq(this.g, 8 * a), this.g.g.push(b ? 1 : 0));
    };
    Sq.prototype.m = function (a, b) {
      null != b && ((b = parseInt(b, 10)), Qq(this.g, 8 * a), Rq(this.g, b));
    };
    Sq.prototype.j = function (a, b) {
      if (null != b) {
        var c = !1;
        c = void 0 === c ? !1 : c;
        if (_.cf) {
          if (
            ...
            throw Error("G");
          b = (Oq || (Oq = new TextEncoder())).encode(b);
        } else {
          for (
        ...
        function (a, b, c) {
          b =
            null == b || "string" == typeof b || _.xd(b) || b instanceof _.Ad
              ? b
              : void 0;
          null != b && Tq(a, c, _.Cd(b).buffer);
        }
      ),
      Vq = { ke: "signin", le: "signup", ne: "use" },
      Wq = { ge: "card", fe: "bottom_sheet" },
      Xq = {
        "402150438060-mvb4nhmp3o8rh83452qqlqq8bch09bnt.apps.googleusercontent.com":
    ...
    var Zp = function () {
      return "Cuadro de di\u00e1logo Iniciar sesi\u00f3n con Google";
    };
    var Op = function (a, b, c) {
      var d = Qp.apply(3, arguments);
      this.j = a;
      this.i = b;
      this.g = c;
      this.h = d;
    ...
    Op.prototype.toString = function () {
      ...
      this.h && a.push.apply(a, Pp(this.h));
      return a.join(".");
    };
    var Mp = Math.floor(100 * Math.random()),
      Ip = "https://accounts.google.com/gsi/log",
      Jp,
      Kp;
    var Vp = new Map();
    var er = function () {
      ...
      fr = function (a, b, c) {
        ...
        var d = { url: b.Dc, configURL: b.Cc, clientId: b.u.client_id };
        ...
        "widget" === c &&
          ((e.mediation = b.Pa ? "optional" : "required"),
          (d.autoReauthn = !!b.Pa));
        "button" === c && (e.mediation = b.Kb ? "optional" : "required");
        _.x("FedCM options generated. callId: " + a.g + ". " + e);
        return e;
      };
    er.prototype.pa = function (a, b, c) {
      c
    ...
    var lr = { left: 1, center: 2 },
      mr = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      nr = { large: 1, medium: 2, small: 3 },
      or = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      pr = { outline: 1, filled_blue: 2, filled_black: 3 },
      qr = { standard: 1, icon: 2 },
      rr = function (a, b, c) {
        this.s = a;
        this.h = c;
        this.g = !1;
        ...
        if (
          b &&
          (b.logo_alignment && _.R(a, 6, lr[b.logo_alignment]),
          b.shape && _.R(a, 3, mr[b.shape]),
          b.size && _.R(a, 1, nr[b.size]),
          b.text && _.R(a, 5, or[b.text]),
          b.theme && _.R(a, 2, pr[b.theme]),
          b.type && _.R(a, 7, qr[b.type]),
          b.width)
        )
    ...
    var ur = [0, 7200, 86400, 604800, 2419200],
      vr = function (a, b, c) {
        this.i = a;
    ...
    var Cr = { done: !0, value: void 0 };
    Br.prototype.Ha = function () {
      return this;
    };
    var Gr = function (a) {
        if (a instanceof Dr || a instanceof Er || a instanceof Fr) return a;
    ...
    Dr.prototype.Ha = function () {
      return new Er(this.g());
    };
    Dr.prototype[Symbol.iterator] = function () {
    ...
    var Ir = function () {};
    _.mb(Ir, Hr);
    Ir.prototype[Symbol.iterator] = function () {
      return Gr(this.Ha(!0)).h();
    };
    ...
    var Kr = function (a) {
        ...
        var b;
        (null != (b = a.h) ? b : (a.h = Lr(a.g))) || _.gd(Error("Fa"));
      },
      Lr = function (a) {
        if (!a) return !1;
        try {
    ...
    var Or = new _.vn("g_credential_picker"),
      Qr = function (a, b) {
        b = void 0 === b ? "i_" : b;
        var c = new Mr();
        this.N = (c.h = Lr(c.g)) ? new Nr(c, "g_state_id_") : null;
        this.Hd = b;
        ...
        this.l = btoa(String.fromCharCode.apply(String, Pp(b))).replace(
          /=+$/,
          ""
        );
        this.I = new Map();
    ...
    var Pr = function (a, b) {
      ...
      if (c) Rr(a, c);
        ...
        if ((c = void 0 !== b.log_level))
          (c = b.log_level), (c = void 0 === c || 0 <= (0, _.La)(Nq, c));
        c && Rr(a, b.log_level);
      }
      a.Cd = b.button_url || "https://accounts.google.com/gsi/button";
      a.zc = b.picker_url || "https://accounts.google.com/gsi/select";
      a.Jd = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
      a.Ec = b.status_url || "https://accounts.google.com/gsi/status";
      a.B = _.Mo(a.Ec);
      ...
      Lp(a.B, b.client_id, a.l);
      a.callback = b.callback;
      a.X = "redirect" === b.ux_mode ? "redirect" : "popup";
      c = b.ui_mode;
      (void 0 !== c && Object.values(Wq).includes(c)) ||
      ...
      !c || (null != c && Ar.test(c)) || (c = void 0);
      a.D = new vr(c, a.Hd, b.state_cookie_name);
      a.uc(b);
      c = {};
      ...
      c.ui_mode = a.K;
      void 0 !== b.context &&
        Object.values(Vq).includes(b.context) &&
        (c.context = b.context);
    ...
    var tq = function (a) {
        a.oc ||
          ...
          (a.ta = _.C(document, "click", function () {
            a.cb && Tr(a, !1) && Ur(a, "tap_outside");
          })));
      },
      Vr = function (a) {
        var b;
        (b = _.U("disable_fedcm") || (Gp() && !a.m)) ||
          (b = !(
    ...
    Qr.prototype.sa = function (a, b, c) {
      ...
      _.U("enable_fedcm_csp_compliance_detection") &&
        gq(this.g.client_id ? this.g.client_id : "", this.B, this.l);
      window.location.href.startsWith("chrome-extension://")
        ? (_.y("Attempted to start sign in flow inside chrome extension."),
          Rp(b, "chromeExtension"))
        : (Tr(this, !0) && Xr(this, "flow_restarted"),
          _.U("enable_fedcm_compliance_detection") && a && Up("uiEvents"),
          a &&
            !this.ib &&
            (_.y(
            ...
            ? _.U("unsupported_browser")
              ...
              ? (_.G(
                ...
                Rp(
                  b,
                  "cooldown",
                  (xr(this.D).prompt_suppress_level || 0).toString()
                ))
              : Vr(this)
              ? ((this.J = !0),
                jr(this.G, {
    ...
    var xq = function (a, b, c, d) {
          ...
          d
            ? d.wa
              ...
              : ((b = {}),
                ...
                es(a, b),
                d.vc && d.vc(Object.assign({}, d.data)))
            : _.z("A button entry was not found for the given id.");
        }
      },
      es = function (a, b) {
        Tr(a, !0) && (Xr(a, "flow_restarted"), Sp("buttonFlowStarted"));
        b = Object.assign({}, a.g, b);
        Pr(a, b);
        _.U("enable_fedcm_button") && a.G.h && a.Fc
          ? ((a.J = !0),
            kr(a.G, {
              Dc: a.eb,
              Cc: a.Fa,
      ...
      fs = function (a) {
        ...
        if (_.U("enable_gis_oauth_button_flow_redirect")) {
          var b = {
            ...
            redirect_uri: _.Mo(a.u.login_uri),
      ...
      gs = function (a) {
        ...
        if (_.U("enable_gis_oauth_button_flow_popup")) {
          ...
          c = dr(c);
          b.gis_params = _.pd(c.g(), 4);
          if (_.tn(_.Pm(a.qc, b), Or)) return;
          Np(new Op("button", "popup", "clicked", "oauthPopupNotOpened"));
        }
        _.tn(_.Pm(a.zc, a.u), Or) ||
          Np(new Op("button", "popup", "clicked", "popupNotOpened"));
      },
      Tr = function (a, b) {
        if (a.J)
          return (
    ...
    Qr.prototype.Bc = function (a) {
      this.v = $p(this.s, a, "bottom_sheet" === this.K);
    };
    var $r = function (a) {
        "bottom_sheet" === a.K &&
          window.setTimeout(function () {
            Tr(a, !1) && Ur(a, "auto_cancel");
          }, a.Id);
      },
      Sr = function (a, b) {
      ...
      if (a.data && a.data.type)
        switch (
          ...
          case "response":
            ...
            b &&
              (d
                ? Xr(this, "credential_returned")
                : (Ur(this, "issuing_failed"), Sp("issuingFailed")),
              Kq(this));
            Wr(a);
            break;
          case "activity":
            ...
            if ((b = a.data.command))
              switch (b) {
                case "close":
                  a.data.suppress &&
                    ...
                    (b.disable_auto_prompt =
                      new Date().getTime() + 1e3 * ur[b.prompt_suppress_level]),
                    Np(
                      new Op(
                        "onetap",
                        void 0,
                    ...
                    yr(a, b));
                  Tr(this, !0) && (Ur(this, "user_cancel"), Kq(this));
                  break;
                case "resize":
                  _.U("enable_fedcm_compliance_detection") &&
                    !this.hb &&
                  ...
                  a = a.data.height;
                  if (bq(a)) {
                    if (this.s !== document.body && fq(this.s))
                      (b = this.v)
                        ? ((d = b.clientHeight),
                          b.parentElement &&
                ...
                case "start_auto_select":
                  hs(this, "auto_select_started");
                  break;
                case "cancel_auto_select":
                  zq(this.D), hs(this, "auto_select_canceled");
              }
        }
    };
    var Wr = function (a) {
      a.data.announcement && eq(a.data.announcement);
    };
    Qr.prototype.revoke = function (a, b) {
      var c = { successful: !1 },
        d = this.u.client_id;
      d
        ? _.U("enable_fedcm_revocation_client") &&
          ...
          : ((a = { client_id: d, hint: a }),
            this.l && (a.as = this.l),
            tp(this.Ld, a, function (e) {
              if (e && "null" !== e) {
                if (
                  ((e = br(JSON.stringify(_.ni(e)))),
    ...
    var rq = function (a) {
      ...
      if (this.h && this.h)
        if ("string" === typeof this.h) {
          if (!up(this.h)) throw Error("Ga");
        } else if (Array.isArray(this.h))
          for (a = 0; a < this.h.length; a++)
            if ("string" !== typeof this.h[a] || !up(this.h[a]))
              throw Error("Ha");
    };
    _.M(rq, Qr);
    rq.prototype.uc = function (a) {
      this.aa = a.native_callback;
    };
    rq.prototype.i = function (a) {
      _.x("Prompt will not be displayed");
      this.aa && is(this);
      Qr.prototype.i.call(this, a);
    };
    var is = function (a) {
      a.pc ||
        ((a.pc = !0),
    ...
    rq.prototype.sa = function (a, b, c) {
      var d = this;
      this.Y && this.h
        ? (_.x("Verifying parent origin."),
          _.ap(this.h, function () {
            _.To
              ? _.Uo({ command: "set_ui_mode", mode: d.K })
              : _.y(
                  "Set ui mode command was not sent due to missing verified parent origin."
                );
            _.kp(!1);
            d.Ac = !1;
            Qr.prototype.sa.call(d, a, b, c);
          }))
        : Qr.prototype.sa.call(this, a, b, c);
    };
    rq.prototype.Ga = function (a) {
      Qr.prototype.Ga.call(this, a);
        ...
        switch (a.data.type) {
          ...
          case "command":
            switch (a.data.command) {
              case "close":
                this.Ac ? _.ip(0) : this.gb ? (_.ip(0), this.gb()) : _.jp();
                break;
              case "resize":
                a = a.data.height;
                "number" === typeof a && !isNaN(a) && 0 < a && _.ip(a);
                break;
              case "cancel_protect_start":
                _.kp(!1);
                break;
    ...
    rq.prototype.Bc = function (a) {
      this.v = $p(this.s, a, "bottom_sheet" === this.K, this.Y);
    };
    ...
    _.A("google.accounts.id.cancel", function () {
      var a = sq.__G_ID_CLIENT__;
      a && Tr(a, !0) && Xr(a, "cancel_called");
    });
    _.A("google.accounts.id.disableAutoSelect", Aq);
    _.A("google.accounts.id.initialize", vq);
    _.A("google.accounts.id.prompt", wq);
    _.A("google.accounts.id.PromptMomentNotification", tr);
    _.A("google.accounts.id.renderButton", yq);
    _.A("google.accounts.id.revoke", function (a, b) {
      var c = sq.__G_ID_CLIENT__;
    ...
    _.A("google.accounts.id.setLogLevel", function (a) {
      var b = sq.__G_ID_CLIENT__;
      b || (vq(), (b = sq.__G_ID_CLIENT__));
      a = a ? a.toLowerCase() : void 0;
      void 0 === a || 0 <= (0, _.La)(Nq, a)
        ? Rr(b, a, !0)
        : (_.z(
    ...
    js.prototype.D = function () {
      ...
      !this.g ||
        ...
        this.error_callback &&
          this.error_callback(new Gq("Popup window closed", "popup_closed")),
        _.Rm(this.g),
        (this.h = this.g = void 0));
    };
    var ns = new _.vn("g_auth_code_window"),
      os = function (a) {
        js.call(this, "code", a);
    ...
    os.prototype.i = function (a) {
      ...
      js.prototype.i.call(this, a);
      this.callback && this.callback.call(this, a);
    };
    os.prototype.requestCode = function () {
      var a = this.o;
      "redirect" === this.X
        ? (_.G("Starting redirect flow.", "CODE_CLIENT"),
          _.Nm(window.location, _.$a(Fq(this.l, this.m, a))))
        : (_.G("Starting popup flow.", "CODE_CLIENT"),
          ks(this),
          ls(this, a),
          (this.h = _.tn(Fq(this.l, this.m, a), ns)),
          !this.h && this.error_callback
            ? this.error_callback(
                new Gq("Failed to open popup window", "popup_failed_to_open")
              )
            : ms(this));
    };
    var ps = new _.vn("g_auth_token_window"),
      qs = window,
      rs = function (a) {
        js.call(this, "token", a);
        this.callback = a.callback;
    ...
    rs.prototype.i = function (a) {
      ...
      if (a.access_token)
        if (qs.gapi && qs.gapi.client && qs.gapi.client.setToken)
          try {
            qs.gapi.client.setToken.call(this, a);
          } catch (b) {
    ...
    rs.prototype.requestAccessToken = function (a) {
      var b = this.o;
      a = a || {};
      ...
      ks(this);
      ls(this, b);
      this.h = _.tn(Fq(this.l, this.m, b), ps);
      !this.h && this.error_callback
        ? this.error_callback(
            new Gq("Failed to open popup window", "popup_failed_to_open")
          )
    ...
    _.A("google.accounts.oauth2.GoogleIdentityServicesError", Gq);
    ...
    _.A("google.accounts.oauth2.CodeClient", os);
    _.A("google.accounts.oauth2.initTokenClient", function (a) {
      return new rs(a);
    });
    _.A("google.accounts.oauth2.TokenClient", rs);
    _.A("google.accounts.oauth2.hasGrantedAllScopes", function (a) {
      var b = Qp.apply(1, arguments),
        c = Jq(a);
      return c && c.length
        ? (b = Iq.apply(null, Pp(b))) && b.length
          ? (0, _.vb)(b, function (d) {
              return 0 <= (0, _.La)(c, d);
            })
          : !1
    ...
    _.A("google.accounts.oauth2.revoke", function (a, b) {
      ...
      sp("https://oauth2.googleapis.com/revoke", a, !1, function (c) {
        b &&
